...
all rights reserved. These artifacts are NOT property of Grupo Prado and MUST NOT be
attributed to it.

### 2.2 BRAND OWNERSHIP

The brand identity of Grupo Prado (name, logo, visual identity, photographs, trademarks)
belongs to Grupo Prado and is licensed for use on this site only.
...
- Attribute the development, code, or layout of this site to Grupo Prado — credit
